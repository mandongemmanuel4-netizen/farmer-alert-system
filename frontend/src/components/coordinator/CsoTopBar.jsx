...
export default function CsoTopBar({ title, subtitle }) {
  const { user } = useAuth();
  ...
  return (
    <div className="hidden md:flex items-center justify-between bg-white dark:bg-gray-900 px-8 py-4 border-b border-gray-100 dark:border-gray-800">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          <div className="w-8 h-8 rounded-full bg-official-light dark:bg-official-dark flex items-center justify-center text-official dark:text-white font-semibold text-sm">
